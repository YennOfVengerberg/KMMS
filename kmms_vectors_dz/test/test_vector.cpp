...
// 	char string[] = {'t', 'e', 's', 't'};
// 	Vector<int> intinit (arrint, sizeof(arrint)/sizeof(int));
// 	Vector<float> floatinit (arrfloat, sizeof(arrfloat)/sizeof(float));
// 	Vector<char> strinit (string, sizeof(string)/sizeof(char));
// 	intinit.print();
// 	floatinit.print();
// 	strinit.print();
// }
